...
export const businessVisitorVisaData: ImmigrationPageData = {
  heading: "Business Visitor Visa",
  description:
  ...
  eligibilityHeading: "Eligibility criteria for a Business Visitor Visa?",
  eligibilityDescription:
    "Before proceeding, learn whether you qualify as a business visitor or if you need to apply for a work permit instead. Business visitors typically stay in Canada for a few days or weeks to attend meetings or events, with a maximum stay of up to 6 months. A separate application can be filed to extend the stay.",

  refusalHeading: "Common Reasons for Refusals of Temporary Resident Permit (TRP)",
  refusals: [],
  ...
  faqs: [
    {
      ...
      answer: "Your planned stay should be less than 6 months.",
    },
    {
      question:
