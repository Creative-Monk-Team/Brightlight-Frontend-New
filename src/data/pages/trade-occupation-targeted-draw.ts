...
export const tradeOccupationTargetedDrawData: ImmigrationPageData = {
  heading:
  ...
  eligibilityHeading: "Eligibility Criteria for Trade Occupations Category",
  ...
  faqs: [
    {
      question: "What is trade occupation in Canada?",
      answer:
    ...
    {
      question: "How often IRCC will hold Trade-specific draws?",
      answer:
