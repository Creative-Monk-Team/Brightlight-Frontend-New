...
export const healthcareTargetedDrawData: ImmigrationPageData = {
  heading:
  ...
  eligibilityHeading: "Eligibility Criteria for Express Entry Healthcare Draws",
  eligibilityDescription:
    "Understanding the process of becoming eligible for Express Entry healthcare draws requires a comprehensive understanding of the Express Entry system itself.",

  drawHeading: "Express Entry Healthcare Draws History",
  ...
  faqs: [
    {
      question: "Who is eligible for healthcare Express Entry?",
      answer:
    ...
    {
      question: "What is the lowest CRS score for healthcare workers?",
      answer:
    ...
    {
      question: "Can I move to Canada as a health care assistant?",
      answer:
    ...
    {
      question: "Can nurses apply for Express Entry in Canada?",
      answer:
        "As a nurse, you may be qualified to come to Canada as a skilled worker through one of the many economic immigration programs at both the federal and provincial level. There are four main ways that you can come to Canada as a nurse: Express Entry (Healthcare Targeted Draws), Quebec Immigration, Provincial Nominee Programs, Study in Canada.",
    },
    {
      question: "What is the age limit for nursing in Canada?",
      answer:
    ...
    {
      question: "How often IRCC will hold Healthcare -specific draws?",
      answer:
