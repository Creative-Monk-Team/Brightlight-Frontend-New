...
export const educationBasedDrawsData: ImmigrationPageData = {
  heading:
    "Express Entry \u2013 Category-Based Draw for Education Professionals (2025)",
  description:
  ...
  benefitsHeading: "Benefits of Applying Under the Education Category",
  benefits: [
  ...
  eligibilityHeading: "Eligibility Criteria for program",
  ...
  refusalHeading: "Common Reasons for Refusals",
  refusals: [
  ...
  drawHeading: "Express Entry Trade Occupations Draw History",
  ...
  faqs: [
    {
      ...
      answer:
        "No. It's part of the existing Express Entry system but prioritizes candidates with work experience in select occupations.",
    },
    {
      question: "Do I need a job offer?",
      answer:
        "Not required, but it can improve your CRS score.",
    },
    {
      question:
        "Can I qualify if I have foreign teaching experience?",
      answer:
        "Yes, if your experience aligns with a listed NOC and meets Canadian equivalency through credential assessment.",
    },
    {
      question: "What is the average CRS score for education draws?",
      answer:
        "It varies by round but is generally lower than general draws, often between 430\u2013470.",
    },
    {
      question: "Is certification or licensing required?",
      answer:
        "Not for Express Entry eligibility, but provincial certification may be required later for employment.",
    },
  ],
